...
/** Android: MapView só com chave Google configurada no EAS; senão placeholder. */
export function AgendaRouteMap({ route, mapRegion, mapsEnabled = false }: AgendaRouteMapProps) {
  if (!mapsEnabled) {
